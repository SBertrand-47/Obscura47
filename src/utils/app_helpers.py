...
def build_quick_start_text(*, connected: bool) -> str:
    ...
    return (
        ...
        "Browse discovery:\n"
        "  - Click Discover Sites to see every live .obscura site the\n"
        "    network knows about (no address needed)\n"
        "  - Or click Browse Directory and enter a known directory address\n"
        "    to search one curated listing\n\n"
