...
ADVERTISED_HOST = getenv_str("OBSCURA_ADVERTISED_HOST", "").strip()
NODE_ADVERTISED_HOST = getenv_str("OBSCURA_NODE_ADVERTISED_HOST", ADVERTISED_HOST).strip()
EXIT_ADVERTISED_HOST = getenv_str("OBSCURA_EXIT_ADVERTISED_HOST", ADVERTISED_HOST).strip()
